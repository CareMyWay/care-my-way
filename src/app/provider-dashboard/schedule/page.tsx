...
export default function SchedulePage() {
  ...
  const loadAvailability = React.useCallback(async () => {
    try {
      ...
      // Load availability data from ProviderProfile
      ...
      if (profiles && profiles.length > 0) {
        ...
        const dayAvailability: DayAvailability[] = weekDays.map((day) => {
          ...
          const sortedHours = dayHours.sort((a, b) => parseInt(a) - parseInt(b));
        ...
        // No provider profile found, create empty availability
        const dayAvailability: DayAvailability[] = weekDays.map((day) => ({
    ...
    <div className="container mx-auto p-6 max-w-7xl">
            ...
            <div className="text-center">
              ...
              <div className="flex items-center justify-center space-x-4 mt-2">
                <Badge variant="secondary">
                  {getTotalHoursForWeek()} hours available
                </Badge>
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-7 gap-4 mb-6">
        {weekData.map((day, index) => (
          <Card key={day.date} className="h-fit">
