          ...
          <div className="flex flex-row justify-between items-center">
            ...
            <div className="text-[23px] font-bold mb-6 visible lg:invisible cursor-pointer"
                 ...
                 <svg
                  ...
                  height="36"
                  viewBox="0 0 24 24">
                  <path d="M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z" className={`${showFilters? "visible" : "invisible"}`}/>
                  <path d="M12 8l-6 6 1.41 1.41L12 10.83l4.59 4.58L18 14z" className={`${showFilters? "invisible" : "visible"}`} />
