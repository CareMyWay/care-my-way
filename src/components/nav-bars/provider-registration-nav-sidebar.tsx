...
export function ProviderRegistrationNavSideBar({
    ...
    onSectionClick,
    sectionCompletion,
}: ProviderRegistrationNavSideBarProps) {
    const sections = [
        {
            id: "personal-contact",
            title: "Personal & Contact Info",
            subtitle: "Basic details & contact",
            step: 1,
        },
        {
            id: "address",
        ...
        },
        {
            ...
            subtitle: "Bio, experience & services",
            step: 4,
        },
        {
            id: "credentials",
            ...
            <div className="p-3 space-y-2">
                {sections.map((section) => {
                    ...
                    return (
                        <div key={section.id}>
                            <div
                                className={`relative p-3 rounded-md border transition-all duration-300 ${isActive
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="relative flex-shrink-0">
                                        <div
                                            className={`flex h-8 w-8 items-center justify-center rounded-full border font-bold text-sm transition-all duration-300 ${status === "completed"
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <h3
                                            className={`font-semibold text-sm mb-1 ${isActive
                                                ? "text-white"
                                                : status === "completed"
                                                    ? "text-green-700"
                                                    : "text-gray-800"
