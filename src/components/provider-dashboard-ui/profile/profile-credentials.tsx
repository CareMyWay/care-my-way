        ...
        <Card className="border border-gray-200 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
          ...
          <CardContent className="p-6 space-y-5">
            {profileData.education.map((edu: EducationEntry, index: number) => (
              <div
                key={index}
                className="relative pl-6 pb-4 border-l-4 border-indigo-200 last:pb-0"
              >
        ...
        <Card className="border border-gray-200 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
          ...
          <CardContent className="p-6 space-y-5">
            {profileData.certifications.map(
              (cert: CertificationEntry, index: number) => (
                <div
                  key={index}
                  className="relative pl-6 pb-4 border-l-4 border-emerald-200 last:pb-0"
                >
        ...
        <Card className="border border-gray-200 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
          ...
          <CardContent className="p-6 space-y-5">
            {profileData.workExperience.map(
              (work: WorkExperienceEntry, index: number) => (
                <div
                  key={index}
                  className="relative pl-6 pb-4 border-l-4 border-blue-200 last:pb-0"
                >
          ...
          <Card className="border border-gray-200 rounded-2xl overflow-hidden shadow-lg">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-600 mb-4">
                Add your education, certifications, and work experience to build
                trust with clients.
              </p>
            </CardContent>
          </Card>
