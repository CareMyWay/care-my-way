...
import { AlertCircle, Edit, FileText, User, Briefcase, BookOpen, Eye } from "lucide-react";
  ...
  if (!profileData || !profileData.isProfileComplete) {
    return (
      <>
        <TopNav
          title="Profile"
          subtitle="Complete your professional profile to get started."
          notificationCount={2}
        />
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="border border-gray-200 rounded-2xl shadow-lg bg-white">
              <CardContent className="p-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                  <Link
                    href="/provider-dashboard/profile/edit"
                  ...
                  <Link
                    href="/provider-dashboard/to-dos/complete-profile"
                    className="w-full sm:w-auto"
                  >
                    <Button
                      variant="outline"
