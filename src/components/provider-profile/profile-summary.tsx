  ...
  const infoRows = [
    {
      ...
      value: profileData.yearsExperience || "Not specified",
    },
    {
      label: "Starting Rate",
      value: profileData.askingRate
        ? `$${profileData.askingRate}/hour`
        : "Rate on request",
    },
    {
      label: "Response Time",
      value: profileData.responseTime || "Not specified",
    },
  ];
  ...
  return (
    <div className="flex flex-col items-center border-solid border-1 rounded-none border-input-border-gray pb-7 w-full md:w-[320px] xl:w-[400px]">
      <div className="flex flex-col items-left w-[360px] p-7">
        ...
        <span className="text-h5-size xl:text-h4-size font-semibold text-darkest-green mt-5 md:mt-10 md:px-7 xl:px-0">
