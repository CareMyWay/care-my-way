...
const ProfileSummary = () => {
  return (
    <div className="flex flex-col items-left w-[370px] p-7">
      <span>
        <Image
          src="/images/home/meet-providers/person-placeholder-1.png"
          alt="Profile Image"
          height={400}
          width={400}
          className="mb-5"
      ...
      <span className="text-h4-size font-semibold text-darkest-green">
        {providerName.toUpperCase()}
      </span>
      <div className="flex">
        <span className="text-body3-size text-darkest-green">
          {providerTitle}
        </span>
      ...
      <div className="flex flex-col gap-4">
        <div className="flex justify-between w-full mt-5">
          <span className="text-body5-size text-darkest-green my-auto">
            Working Experience
          </span>
          <span className="text-body4-size text-darkest-green font-semibold my-auto">
            {workExperience}
          </span>
        </div>
