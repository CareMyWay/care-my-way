...
export const staticQuizData: Question[] = [
  ...
  {"q-idx": 4  , "q-str": "How often do you experience pain that limits your daily activities?"                                                    , "a-tp": "radio",    "radios":     ["Never", "Occasionally", "Frequently", "Always"]},
  ...
  {"q-idx": 9  , "q-str": "Do you manage your medications on your own (e.g., remembering when and how much to take)?"                              , "a-tp": "radio",    "radios":     ["Yes", "With reminders or a pill organizer", "Someone else manages it for me"]},
  ...
  {"q-idx": 13 , "q-str": "Have others expressed concern about changes in your behavior or memory?"                                                , "a-tp": "radio",    "radios":     ["Yes", "No", "Not sure"]},
  ...
  {"q-idx": 17 , "q-str": "How often do you feel lonely or isolated?"                                                                              , "a-tp": "radio",    "radios":     ["Never", "Sometimes", "Often", "Always"]},
