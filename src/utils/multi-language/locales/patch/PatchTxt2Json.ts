...
const getResources = async () => {
  ...
  const outputFileName = "src/utils/multi-language/locales/locales-common.json";
  const backupFileName = `src/utils/multi-language/locales/bak/locales-common.bak.${Date.now()}.json`;
  const patchFileName = "src/utils/multi-language/locales/logs/patch.json.txt";
...
// call me: node --import=tsx  src/utils/multi-language/locales/patch/PatchTxt2Json.ts
